...
<section id="service-section" class="mt-5 mb-5 pr-3">
        ...
        <div class="row">
          <div class="col-lg-4 ">
            <img class="rounded-circle" src="https://img.freepik.com/free-photo/photorealistic-wedding-venue-with-intricate-decor-ornaments_23-2151481485.jpg?ga=GA1.1.1386242406.1732780479&semt=ais_hybrids" alt="Generic placeholder image" width="240" height="240">
            <h2>HALLS</h2>
            <p>Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.</p>
            <!-- <p><a class="btn btn-warning" href="#" role="button">View details &raquo;</a></p> -->
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4">
            <img class="rounded-circle" src="https://img.freepik.com/free-vector/buffet-concept-illustration_114360-22987.jpg?ga=GA1.1.1386242406.1732780479&semt=ais_hybrid" alt="Generic placeholder image" width="240" height="240">
            <h2>CATERING</h2>
            <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh.</p>
            <!-- <p><a class="btn btn-warning" href="#" role="button">View details &raquo;</a></p> -->
          </div>
          <div class="col-lg-4">
            <img class="rounded-circle" src="https://img.freepik.com/free-vector/support-local-business-concept_23-2148595317.jpg?ga=GA1.1.1386242406.1732780479&semt=ais_hybrid" alt="Generic placeholder image" width="240" height="240">
            <h2>VENDORS</h2>
